...
class sql:
    ...
    def create_table():
        ...
        try:
            ...
            config ={
             'user':'root', 'password':'Roman9804',
             'host':'127.0.0.1','database':'Retail_Sales_Data'
    }
            ...
            st.warning("There is no database named 'Retail_Sales_Data'. Please create the database.")
...
class comparison:
    ...
    def previous_week_sales_comparison(df, day, month, year):
        ...
        holiday = {0: 'No', 1: 'Yes'}
        type = {1: 'A', 2: 'B', 3: 'C'}
        st.code(f'''Type : {type[current_data['Type']]}        Size : {current_data['Size']}''')
